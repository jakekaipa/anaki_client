...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('transactions', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger("forexcrow_id")->nullable();
            $table->enum("type",[
                ...
                PaymentGatewayConst::EXCROW,
                PaymentGatewayConst::MARKETPLACE,
            ]);
            ...
            $table->foreign("forexcrow_id")->references("id")->on("forexcrows")->onDelete("cascade")->onUpdate("cascade");
