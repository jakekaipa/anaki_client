...
use App\Http\Controllers\Admin\ExcrowController;
...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    // Add Forexcrow Logs
    Route::controller(ExcrowController::class)->prefix('trades')->name('trade.')->group(function () {
        Route::get('index', 'index')->name('index');
        Route::get('pending', 'pending')->name('pending');
        Route::get('payment/pending', 'paymentPending')->name('payment.pending');
        Route::get('ongoing', 'ongoingLogs')->name('ongoing');
        Route::get('complete', 'complete')->name('complete');
        Route::get('canceled', 'canceled')->name('canceled');
        Route::get('closed/requested', 'closedRequest')->name('closed.requested');
        Route::get('closed', 'closed')->name('closed');
        Route::put('closed/requested/approved', 'closedRequestApprove')->name('closed.requested.approved');
        Route::put('closed/request/rejected', 'closeRequestRejected')->name('closed.requested.rejected');
        Route::put('approved', 'approved')->name('approved');
        Route::put('rejected', 'rejected')->name('rejected');
        Route::get('details/{id}', 'logDetails')->name('details');
    });
    ...
    Route::prefix('app-settings')->name('app.settings.')->group(function () {
        Route::controller(AppSettingsController::class)->group(function () {
            ...
            Route::post('theme', 'setTheme')->name('theme');
        });
