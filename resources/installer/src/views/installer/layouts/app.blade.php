...
<head>
    ...
    <!-- favicon -->
    <link rel="shortcut icon" href="{{ asset('/resources/installer/src/assets/images/logo/favicon.png') }}"
        type="image/x-icon">
    <!-- lightcase css links -->
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
    ...
    <!-- jquery -->
    <script src="{{ asset('../resources/installer/src/assets/js/jquery-3.5.1.js') }}"></script>
    <!-- bootstrap js -->
