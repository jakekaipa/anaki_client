            ...
            <div class="dash-payment-item active">
                    ...
                    <div class="preview-list-wrapper">
                        <div class="preview-list-item">
                            ...
                            <div class="preview-list-right">
                                <span>{{ getDynamicAmount($excrow->rate, $excrow->rateCurrency->code) }}</span>
                            </div>
                        </div>
                        <div class="preview-list-item">
                            <div class="preview-list-left">
                            ...
                            <div class="preview-list-right">
                                <span>{{ getDynamicAmount($total_charge, $excrow->rateCurrency->code) }}</span>
                            </div>
                        </div>
                        <div class="preview-list-item">
                            <div class="preview-list-left">
                            ...
                            <div class="preview-list-right">
                                <span>{{ getDynamicAmount($total_charge + $excrow->rate, $excrow->rateCurrency->code) }}</span>
                            </div>
                        </div>
                        <div class="preview-list-item">
                            <div class="preview-list-left">
                            ...
                            <div class="preview-list-right">
                                <span class="text--warning last">{{ getDynamicAmount($excrow->amount, $excrow->saleCurrency->code) }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                <form class="card-form mt-20" action="{{ setRoute('user.marketplace.buy') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <input type="hidden" name="excrow_id" value="{{ $excrow->id }}">
                        <div class="col-xl-12">
