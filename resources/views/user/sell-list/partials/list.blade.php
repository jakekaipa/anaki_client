@forelse ($listData as $item)
    <li class="plist__item" data-href="{{ setRoute('user.sell-list.preview', urlSafeEncrypt($item->id)) }}">
        <div class="plist__head">
            <div class="plist__head-col">
                <div class="flex-s-c">
                    <p class="plist__head-txt">{{ __('seller') }}</p>
        ...
        <div class="plist__info">
            <div class="plist__col">
                <div class="plist__auth">
                    <span class="plist__auth1">{{ __('seller') }}</span>
            ...
            <div class="plist__btn">
                ...
                @endif
                <a href="{{ setRoute('user.sell-list.preview', urlSafeEncrypt($item->id)) }}" class="plist__buy">
                    <span class="txt">{{ __('buy') }}</span>
                </a>
            </div>
        </div>
    </li>
