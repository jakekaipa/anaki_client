        ...
        <div class="dash-payment-item-wrapper">
            <div class="dash-payment-item active">
                <div class="dash-payment-title-area">
                    ...
                    <h5 class="title">Fee calculator Form</h5>
                </div>
                <div class="dash-payment-body">
                    <form class="card-form mt-30" method="GET">
                        @csrf
                        <div class="intervals" data-intervals="{{ json_encode($intervals) }}"></div>
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 form-group text-center">
                                <div class="exchange-area">
                                    <code class="d-block text-center"><span>{{ __("Exchange Rate") }}</span> <span class="exchange_rate">--</span></code>
                                </div>
                            </div>
