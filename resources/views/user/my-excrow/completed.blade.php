        ...
        <div class="dash-payment-item-wrapper">
            <div class="dash-payment-item active">
                <div class="dash-payment-title-area">
                    ...
                    <h5 class="title">Transaction Created!</h5>
                </div>
                <div class="card-body">
                    <div class="content text-center mt-20">
                        <h3 class="title">Trade Create Successfully</h3>
                        <p>You can share this URL or QR code with a potential buyer if you already have one!</p>
                    </div>
                    <form class="card-form mt-20" action="dashboard.html">
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12">
                                <a href="{{ setRoute('user.my-excrow.index') }}" class="btn--base w-100"><i class="las la-angle-left me-1"></i> Back To My Trade</a>
                            </div>
                        </div>
                    </form>
                </div>
