        ...
        <div class="dash-payment-item-wrapper">
            <div class="dash-payment-item active">
                ...
                <div class="dash-payment-body">
                    ...
                    <form class="card-form" action="{{ setRoute('user.my-excrow.update') }}" method="POST">
                        @csrf
                        <input type="hidden" name="target" value="{{ $excrow->id }}">
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-6 form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" step="0.01" class="form--control" placeholder="0.00" required name="amount" maxlength="20" value="{{ old('amount', get_amount($excrow->amount)) }}" disabled>
                                    <select class="form--control nice-select" style="display: none;" name="currency">
                                        <option value="{{ $excrow->saleCurrency->id }}"
                                            data-currency="{{ $excrow->saleCurrency->code }}"
                                            data-rate="{{ $excrow->saleCurrency->rate }}"
                                        >{{ $excrow->saleCurrency->code }}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" step="0.01" class="form--control rate_amount" placeholder="0.00" name="rate" required maxlength="20" value="{{ old('rate', getDynamicAmount($excrow->rate)) }}">
                            ...
                            <div class="col-xl-12 col-lg-12">
                                <button type="submit" class="btn--base w-100">Update <i class="fas fa-angle-right ms-1"></i></button>
                            </div>
                        </div>
                    </form>
                </div>
