            ...
            <ul class="sidebar-menu">
                        ...
                        'dropdown' => [
                            [
                                ...
                                'links' => [
                                    ...
                                    [
                                        'title' => 'Close Request Pending',
                                        'route' => 'admin.trade.closed.requested',
                                    ],
                                    [
                                        'title' => 'Closed Logs',
                                        'route' => 'admin.trade.closed',
                                    ],
                                    [
                                        'title' => 'All Logs',
                ...
                @if (admin_permission_by_name('admin.setup.sections.section'))
                    ...
                    @php
                        ...
                        $setup_section_childs = [
                            ...
                            setRoute('admin.setup.sections.section', 'how_it_work'),
                            setRoute('admin.setup.sections.section', 'service_section'),
                            setRoute('admin.setup.sections.section', 'overview_section'),
                            setRoute('admin.setup.sections.section', 'testimonial_section'),
                            setRoute('admin.setup.sections.section', 'why_chose_us_section'),
                            setRoute('admin.setup.sections.section', 'download-app'),
                            setRoute('admin.setup.sections.section', 'contact'),
                            setRoute('admin.setup.sections.section', 'fee-calculato'),
                    ...
                    <li class="sidebar-menu-item sidebar-dropdown @if (in_array($current_url, $setup_section_childs)) active @endif">
                        ...
                        <ul class="sidebar-submenu">
                            <li class="sidebar-menu-item">
                                <a href="{{ setRoute('admin.setup.sections.section', 'home_banner') }}"
                                    class="nav-link @if ($current_url == setRoute('admin.setup.sections.section', 'home_banner')) active @endif">
                                    <i class="menu-icon las la-ellipsis-h"></i>
                                    <span class="menu-title">{{ __('Home Banner') }}</span>
                                </a>
                                <a href="{{ setRoute('admin.setup.sections.section', 'about_section') }}"
                                    class="nav-link @if ($current_url == setRoute('admin.setup.sections.section', 'about_section')) active @endif">
                                    <i class="menu-icon las la-ellipsis-h"></i>
                                    <span class="menu-title">{{ __('About Section') }}</span>
                                </a>
                                <a href="{{ setRoute('admin.setup.sections.section', 'how_it_work') }}"
                                    class="nav-link @if ($current_url == setRoute('admin.setup.sections.section', 'how_it_work')) active @endif">
                                    <i class="menu-icon las la-ellipsis-h"></i>
                                    <span class="menu-title">{{ __('How It Works') }}</span>
                                </a>
                                <a href="{{ setRoute('admin.setup.sections.section', 'overview_section') }}"
                                    class="nav-link @if ($current_url == setRoute('admin.setup.sections.section', 'overview_section')) active @endif">
                                    <i class="menu-icon las la-ellipsis-h"></i>
                                    <span class="menu-title">{{ __('Overview Section') }}</span>
                                </a>
                                <a href="{{ setRoute('admin.setup.sections.section', 'why_chose_us_section') }}"
                                    class="nav-link @if ($current_url == setRoute('admin.setup.sections.section', 'why_chose_us_section')) active @endif">
                                    <i class="menu-icon las la-ellipsis-h"></i>
                                    <span class="menu-title">{{ __('Why Chose Us Section') }}</span>
                                </a>
                                <a href="{{ setRoute('admin.setup.sections.section', 'testimonial_section') }}"
                                    class="nav-link @if ($current_url == setRoute('admin.setup.sections.section', 'testimonial_section')) active @endif">
                                    <i class="menu-icon las la-ellipsis-h"></i>
                                ...
                                <a href="{{ setRoute('admin.setup.sections.section', 'partner_section') }}"
                                    class="nav-link @if ($current_url == setRoute('admin.setup.sections.section', 'partner_section')) active @endif">
                                    <i class="menu-icon las la-ellipsis-h"></i>
                                    <span class="menu-title">{{ __('Partner Section') }}</span>
                                </a>
                                <a href="{{ setRoute('admin.setup.sections.section', 'footer-section') }}"
                                    class="nav-link @if ($current_url == setRoute('admin.setup.sections.section', 'footer-section')) active @endif">
                                    <i class="menu-icon las la-ellipsis-h"></i>
                                    <span class="menu-title">{{ __('Footer Section') }}</span>
                                </a>
                                <a href="{{ setRoute('admin.setup.sections.section', 'service-section') }}"
                                    class="nav-link @if ($current_url == setRoute('admin.setup.sections.section', 'service-section')) active @endif">
                                    <i class="menu-icon las la-ellipsis-h"></i>
                                ...
                                <a href="{{ setRoute('admin.setup.sections.section', 'fee-calculator') }}"
                                    class="nav-link @if ($current_url == setRoute('admin.setup.sections.section', 'fee-calculator')) active @endif">
                                    <i class="menu-icon las la-ellipsis-h"></i>
                                    <span class="menu-title">{{ __('Fee Calculator') }}</span>
                                </a>
                                ...
                                <a href="{{ setRoute('admin.setup.sections.section', 'faq-section') }}"
                                    class="nav-link @if ($current_url == setRoute('admin.setup.sections.section', 'faq-section')) active @endif">
                                    <i class="menu-icon las la-ellipsis-h"></i>
                                    <span class="menu-title">{{ __('Faq Section') }}</span>
                                </a>
                                <a href="{{ setRoute('admin.setup.sections.web-jornal.index') }}"
                                    class="nav-link @if ($current_url == setRoute('admin.setup.sections.web-jornal.index')) active @endif">
                                    <i class="menu-icon las la-ellipsis-h"></i>
                                    <span class="menu-title">{{ __('Web Journal') }}</span>
                                </a>
                                <a href="{{ setRoute('admin.setup.sections.section', 'login-section') }}"
                                    class="nav-link @if ($current_url == setRoute('admin.setup.sections.section', 'login-section')) active @endif">
                                    <i class="menu-icon las la-ellipsis-h"></i>
                                    <span class="menu-title">Login Section</span>
                                </a>
                                <a href="{{ setRoute('admin.setup.sections.section', 'register-section') }}"
                                    class="nav-link @if ($current_url == setRoute('admin.setup.sections.section', 'register-section')) active @endif">
                                    <i class="menu-icon las la-ellipsis-h"></i>
                ...
                @if (admin_permission_by_name('admin.payment.gateway.view'))
                    ...
                    @php
                        ...
                        $payment_money_out_childs = [setRoute('admin.payment.gateway.view', ['money-out', 'manual'])];
                        $payment_receiving_method_childs = [
                            setRoute('admin.payment.gateway.view', ['receiving-method', 'manual']),
                        ];
                    @endphp -->
                    ...
                    <li class="sidebar-menu-item sidebar-dropdown @if (in_array($current_url, $payment_receiving_method_childs)) active @endif">
                        <a href="javascript:void(0)">
                            <i class="las la-hand-holding-usd menu-icon"></i>
                            <span class="menu-title">{{ __('Receiving Method') }}</span>
                        </a>
                        <ul class="sidebar-submenu">
                            <li class="sidebar-menu-item">
                                <a href="{{ setRoute('admin.payment.gateway.view', ['receiving-method', 'manual']) }}" class="nav-link @if ($current_url == setRoute('admin.payment.gateway.view', ['receiving-method', 'manual'])) active @endif">
                                    <i class="menu-icon las la-ellipsis-h"></i>
                                    <span class="menu-title">{{ __('Manual') }}</span>
                                </a>
                            </li>
