                            ...
                            <tr>
                                ...
                                <td>
                                    @include('admin.components.link.edit-default', [
                                        'href' => setRoute('admin.payment.gateway.edit', [
                                            'add-money',
                                            'automatic',
                                            $item->alias,
                                        ]),
            ...
            <div class="modal-data">
                ...
                <div class="modal-form-data">
                    <form class="modal-form" method="POST"
                        action="{{ setRoute('admin.payment.gateway.store', ['add-money', 'automatic']) }}"
                        ...
                        <div class="row mb-10-none">
                            ...
                            <div class="col-xl-12 col-lg-12 form-group">
                                <div class="custom-inner-card input-field-generator"
                                    data-source="add_money_automatic_gateway_credentials_field">
