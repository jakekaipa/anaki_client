                                ...
                                <tbody>
                                    @forelse ($logs as $key => $item)
                                        <tr>
                                            ...
                                            <td>{{ $item->subject }}</td>
                                            <td title="{{ strip_tags($item->message) }}">
                                                {{ Str::words(strip_tags($item->message), 5, '...') }}</td>
                                            <td>
                                                <a href="{{ setRoute('admin.users.details', $item->user->username) }}"
                                                    class="btn btn--base"><i class="las la-info-circle"></i></a>
                                            </td>
                                        </tr>
                                    @empty
