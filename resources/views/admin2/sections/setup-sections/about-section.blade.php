                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-4 col-lg-4">
                                            <div class="form-group">
                                                @include('admin.components.form.input',[
                                                    'label'     => "Experience*",
                                                    'name'      => $default_lang_code . "_experience",
                                                    'type' => 'number',
                                                    'placeholder' => '00',
                                                    'value'     => old($default_lang_code . "_experience",$data->value->language->$default_lang_code->experience ?? "")
                                                ])
                                            </div>
                                        </div>
                                        <div class="col-xl-4 col-lg-4">
                                            <div class="form-group">
                                                @include('admin.components.form.input',[
                                                    'label'     => "Feedback*",
                                                    'name'      => $default_lang_code . "_feedback",
                                                    'type' => 'number',
                                                    'placeholder' => '00',
                                                    'value'     => old($default_lang_code . "_feedback",$data->value->language->$default_lang_code->feedback ?? "")
                                                ])
                                            </div>
                                        </div>
                                        <div class="col-xl-4 col-lg-4">
                                            <div class="form-group">
                                                @include('admin.components.form.input',[
                                                    'label'     => "Contributors*",
                                                    'name'      => $default_lang_code . "_contributors",
                                                    'type' => 'number',
                                                    'placeholder' => '00',
                                                    'value'     => old($default_lang_code . "_contributors",
                                                    $data->value->language->$default_lang_code->contributors ?? "")
                                                ])
                                            </div>
                                        </div>
                                    </div>
