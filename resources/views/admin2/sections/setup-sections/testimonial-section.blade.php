                                ...
                                <div class="tab-pane @if (get_default_language_code() == language_const()::NOT_REMOVABLE) fade show active @endif" id="english" role="tabpanel" aria-labelledby="english-tab">
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            @include('admin.components.form.input',[
                                                'label'     => "Review Title*",
                                                'name'      => $default_lang_code . "_review_title",
                                                'value'     => old($default_lang_code . "_review_title",$data->value->language->$default_lang_code->review_title ?? "")
                                            ])
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="tab-pane @if (get_default_language_code() == $item->code) fade show active @endif" id="{{ $item->name }}" role="tabpanel" aria-labelledby="english-tab">
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                @include('admin.components.form.input',[
                                                    'label'     => "Review Title*",
                                                    'name'      => $lang_code . "_review_title",
                                                    'value'     => old($lang_code . "_review_title",$data->value->language->$lang_code->review_title ?? "")
                                                ])
                                            </div>
                                            <div class="form-group">
                                                @include('admin.components.form.textarea',[
                            ...
                            <div class="col-xl-6 col-lg-6">
                                <div class="form-group">
                                    @include('admin.components.form.input',[
                                        ...
                                        'name'      =>"rating",
                                        'type'      => 'number',
                                        'value'     => old("rating",$data->value->rating ?? "")
                                    ])
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6">
                                <div class="form-group">
                                    @include('admin.components.form.input',[
                                        ...
                                        'name'      =>"total_review",
                                        'type'      => 'number',
                                        'value'     => old("total_review",
                                        $data->value->total_review ?? "")
                                    ])
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="col-xl-6 col-lg-6">
                                            <div class="form-group">
                                                @include('admin.components.form.input',[
                                                    ...
                                                    'value'     => old($default_lang_code . "_designation_edit",$data->value->language->$default_lang_code->name ?? "")
                                                ])
                                            </div>
                                        </div>
                                    </div>
...
@push('script')
    ...
    <script>
        ...
        $(".edit-modal-button").click(function(){
            ...
            // console.log(oldData.language[default_language].designation);
