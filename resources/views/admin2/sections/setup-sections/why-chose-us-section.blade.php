...
@section('content')
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#why-chose-us-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i> {{ __("Add Item") }}</a>
                </div>
            </div>
    ...
    @include('admin.components.modals.site-section.add-why-chose-us-item')

    {{--  Item Edit Modal --}}
    <div id="why-chose-us-edit" class="mfp-hide large">
    ...
    <div id="why-chose-us-view-modal" class="mfp-hide">
        <div class="modal-data">
            <div class="modal-header px-0">
...
@push('script')
    ...
    <script>
        openModalWhenError("why-chose-us-add","#why-chose-us-add");
        openModalWhenError("why-chose-us-edit","#why-chose-us-edit");
        ...
        $(".edit-modal-button").click(function(){
            ...
            var editModal = $("#why-chose-us-edit");
            ...
            fileHolderPreviewReInit("#why-chose-us-edit input[name=image]");
            openModalBySelector("#why-chose-us-edit");

        });

        $(".view-modal-button").click(function(){
            var oldData = JSON.parse($(this).parents("tr").attr("data-item"));
            var editModal = $("#why-chose-us-view-modal");

            editModal.find(".view").text(oldData.language[default_language].details);

            openModalBySelector("#why-chose-us-view-modal");
        });
