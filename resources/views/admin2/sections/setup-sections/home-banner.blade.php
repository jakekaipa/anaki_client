                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 col-lg-6 form-group">
                                            <div class="form-group">
                                                @include('admin.components.form.input',[
                                                    'label'     => "Box Title*",
                                                    'name'      => $default_lang_code . "_box_title",
                                                    'value'     => old($default_lang_code . "_box_title",$data->value->language->$default_lang_code->box_title ?? "")
                                                ])
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 form-group">
                                            <div class="form-group">
                                                @include('admin.components.form.input',[
                                                    'label'     => "Box Value*",
                                                    'name'      => $default_lang_code . "_box_value",
                                                    'value'     => old($default_lang_code . "_box_value",$data->value->language->$default_lang_code->box_value ?? "")
                                                ])
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6 col-lg-6 form-group">
                                                <div class="form-group">
                                                    @include('admin.components.form.input',[
                                                        'label'     => "Box Title*",
                                                        'name'      => $lang_code . "_box_title",
                                                        'value'     => old($lang_code . "_box_title",$data->value->language->$lang_code->box_title ?? "")
                                                    ])
                                                </div>
                                            </div>
                                            <div class="col-xl-6 col-lg-6 form-group">
                                                <div class="form-group">
                                                    @include('admin.components.form.input',[
                                                        'label'     => "Box Value*",
                                                        'name'      => $lang_code . "_box_value",
                                                        'value'     => old($lang_code . "_box_value",$data->value->language->$lang_code->box_value ?? "")
                                                    ])
                                                </div>
                                            </div>
                                        </div>
