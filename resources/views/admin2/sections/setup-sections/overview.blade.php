...
@section('content')
                                        ...
                                        <div class="col-xl-6 col-lg-6">
                                            <div class="form-group">
                                                @include('admin.components.form.textarea',[
                                                    ...
                                                    'name'      => $default_lang_code . "_sub_heading_top",
                                                    'value'     => old($default_lang_code . "_sub_heading_top",$data->value->language->$default_lang_code->sub_heading_top ?? ""),
                                                    'class'     => "form--control",
                                                    'data_limit' => 255,
                                                ])
                                            </div>
                                        ...
                                        <div class="col-xl-6 col-lg-6">
                                            <div class="form-group">
                                                @include('admin.components.form.textarea',[
                                                    ...
                                                    'name'      => $default_lang_code . "_sub_heading_bottom",
                                                    'value'     => old($default_lang_code . "_sub_heading_bottom",$data->value->language->$default_lang_code->sub_heading_bottom ?? ""),
                                                    'class'     => "form--control",
                                                    'data_limit' => 255,
                                                ])
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6 col-lg-6">
                                                <div class="form-group">
                                                    @include('admin.components.form.textarea',[
                                                        'label'     => "Sub Heading*",
                                                        'name'      => $lang_code . "_sub_heading_top",
                                                        'value'     => old($lang_code . "_sub_heading_top",$data->value->language->$lang_code->sub_heading_top ?? ""),
                                                        'class'     => "form--control",
                                                        'data_limit' => 255,
                                                    ])
                                                </div>
                                            ...
                                            <div class="col-xl-6 col-lg-6">
                                                <div class="form-group">
                                                    @include('admin.components.form.textarea',[
                                                        'label'     => "Sub Heading Bottom*",
                                                        'name'      => $lang_code . "_sub_heading_bottom",
                                                        'value'     => old($lang_code . "_sub_heading_bottom",$data->value->language->$lang_code->sub_heading_bottom ?? ""),
                                                        'class'     => "form--control",
                                                        'data_limit' => 255,
                                                    ])
                                                </div>
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#overview-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i> {{ __("Add Item") }}</a>
                </div>
            </div>
                    ...
                    <tbody>
                        @forelse ($data->value->items ?? [] as $key => $item)
                            <tr data-item="{{ json_encode($item) }}">
                                ...
                                <td style="width: 50%">{{ @$item->language->en->value }}</td>
                                <td>
    ...
    @include('admin.components.modals.site-section.add-overveiw-item')

    {{--  Item Edit Modal --}}
    <div id="overview-edit" class="mfp-hide large">
        <div class="modal-data">
            <div class="modal-header px-0">
                <h5 class="modal-title">{{ __("Edit Overview") }}</h5>
            </div>
                            ...
                            <div class="tab-content" id="nav-tabContent">
                                ...
                                <div class="tab-pane @if (get_default_language_code() == language_const()::NOT_REMOVABLE) fade show active @endif" id="edit-modal-english" role="tabpanel" aria-labelledby="edit-modal-english-tab">
                                    ...
                                    <div class="form-group">
                                        @include('admin.components.form.textarea',[
                                            'label'     => "Value*",
                                            'name'      => $default_lang_code . "_value_edit",
                                            'value'     => old($default_lang_code . "_value_edit",$data->value->language->$default_lang_code->value ?? ""),
                                            'class'     => "form--control",
                                            'data_limit' => 255,
                                        ])
                                    </div>
...
@push('script')
    ...
    <script>
        openModalWhenError("overview-add","#overview-add");
        openModalWhenError("overview-edit","#overview-edit");
        ...
        $(".edit-modal-button").click(function(){
            ...
            var editModal = $("#overview-edit");

            console.log(oldData.icon);

            editModal.find("form").first().find("input[name=target]").val(oldData.id);
            editModal.find("input[name="+default_language+"_name_edit]").val(oldData.language[default_language].name);
            editModal.find("textarea[name="+default_language+"_value_edit]").val(oldData.language[default_language].value);
            ...
            fileHolderPreviewReInit("#overview-edit input[name=image]");
            openModalBySelector("#overview-edit");

        });

        $(".view-modal-button").click(function(){
            var oldData = JSON.parse($(this).parents("tr").attr("data-item"));
            var editModal = $("#overview-view-modal");

            editModal.find(".view").text(oldData.language[default_language].value);

            openModalBySelector("#overview-view-modal");
        });
