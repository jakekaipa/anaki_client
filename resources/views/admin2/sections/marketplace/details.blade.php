...
@section('content')
    <div class="custom-card">
        <div class="card-header">
            <h6 class="title">{{ __("Marketplace Details") }}</h6>
        </div>
        <div class="card-body">
                ...
                <div class="row align-items-center mb-10-none">
                    ...
                    <div class="col-xl-4 col-lg-4 form-group">
                        <div class="user-profile-thumb">
                            <img src="{{ isset($data->currency->payment_gateway_id) ? get_gateway_image($data->currency->payment_gateway_id) : '' }}" alt="payment">
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 form-group">
                        <ul class="user-profile-list two">
                            ...
                            <li class="three">Buyer Will Get: <span>{{ number_format(@$data->forexcrow->amount,2) }} {{ @$data->forexcrow->saleCurrency->code }}</span></li>
                            <li class="four">Payable: <span>{{ number_format(@$data->payable,2) }} {{ @$data->currency->currency_code }}</span></li>
                            <li class="five">Status:  <span class="{{ @$data->stringMarketplaceStatus->class }}">{{ @$data->stringMarketplaceStatus->value }}</span></li>
                        </ul>
                    </div>
                </div>
            </form>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="modal-form" action="{{ setRoute('admin.marketplace.approved') }}" method="POST">
        ...
        <div class="modal fade" id="rejectModal" tabindex="-1" >
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="modal-form" action="{{ setRoute('admin.marketplace.rejected') }}" method="POST">
                            @csrf
                            @method("PUT")
                            <div class="row mb-10-none">
                                <div class="col-xl-12 col-lg-12 form-group">
