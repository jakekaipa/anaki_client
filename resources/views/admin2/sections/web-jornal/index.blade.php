        ...
        <div class="table-wrapper">
            <div class="table-header">
                ...
                <div class="table-btn-area">
                    <a href="#event-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i> {{ __('Add Web Journal') }}</a>
                </div>
            </div>
                    ...
                    <tbody>
                        @forelse ($data ?? [] as $key => $item)
                            <tr data-item="{{ json_encode($item) }}">
                                <td>
                                    <ul class="user-list">
                                        <li><img src="{{ get_image($item->image, 'web-jornal') }}" alt="Campaign Image"></li>
                                    </ul>
                                </td>
                                <td>
...
@push('script')
    <script>
        openModalWhenError("web-jornal-add", "#web-jornal-add");
