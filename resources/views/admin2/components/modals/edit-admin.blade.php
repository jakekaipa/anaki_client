        ...
        <div id="admin-edit" class="mfp-hide large">
            <div class="modal-data">
                ...
                <div class="modal-form-data">
                    <form class="modal-form" method="POST" action="{{ setRoute('admin.admins.admin.update') }}"
                        ...
                        <div class="row mb-10-none">
                            ...
                            <div class="col-xl-6 col-lg-6 form-group role-select-wrp"
                                data-admin-roles="{{ json_encode($admin_roles) }}">
                                <label>{{ __('Role*') }}</label>
                                <select class="form--control select2-auto-tokenize" name="edit_role[]"
                                    data-old="{{ old('edit_role') }}" multiple data-placeholder="Select Role">
