<?php $__empty_1 = true; $__currentLoopData = $listData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
    <li class="plist__item" data-href="<?php echo e(setRoute('user.sell-list.preview', urlSafeEncrypt($item->id))); ?>">
        <div class="plist__head">
            <div class="plist__head-col">
                <div class="flex-s-c">
                    <p class="plist__head-txt"><?php echo e(__('seller')); ?></p>
        ...
        <div class="plist__info">
            <div class="plist__col">
                <div class="plist__auth">
                    <span class="plist__auth1"><?php echo e(__('seller')); ?></span>
            ...
            <div class="plist__btn">
                ...
                <?php endif; ?>
                <a href="<?php echo e(setRoute('user.sell-list.preview', urlSafeEncrypt($item->id))); ?>" class="plist__buy">
                    <span class="txt"><?php echo e(__('buy')); ?></span>
                </a>
            </div>
        </div>
    </li>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
    <li class="plist__item2">
        <h3 class="text-warning text-center"><?php echo e(__('no_data_found')); ?></h3>
    </li>
<?php endif; ?>
<?php /**PATH /var/www/html/resources/views/user/sell-list/partials/list.blade.php ENDPATH**/ ?>