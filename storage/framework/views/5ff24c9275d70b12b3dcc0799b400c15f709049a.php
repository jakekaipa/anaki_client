...
<?php $__env->startSection('content'); ?>
    <form action="<?php echo e(setRoute('user.make-offer.submit')); ?>" method="POST" enctype="multipart/form-data" autocomplete="off">
        <?php echo csrf_field(); ?>
        <?php echo method_field('PUT'); ?>

        <div id="Phase1" class="content offer offer1">
            <h2 class="page-tit"><?php echo e(__('Create Tether Trade')); ?></h2>
                ...
                <div class="card-box border">
                    <div class="step">
                        <div class="step-chip active">
                            ...
                            <span class="step-txt"><?php echo e(__('Payment Method')); ?></span>
                        </div>
                        <div class="step-chip">
                            <span class="step-num">②</span>
                            <span class="step-txt"><?php echo e(__('Price')); ?></span>
                        </div>
                        <div class="step-chip">
                            <span class="step-num">③</span>
                            <span class="step-txt"><?php echo e(__('Other Settings')); ?></span>
                        </div>
                    </div>

                    <h3 class="step-tit"><?php echo e(__('Select Cryptocurrency')); ?></h3>

                    <div class="select-coin">
                        <div class="radio-el">
                            <input type="radio" id="coin1" class="coin-radio" checked name="coin" value="tether">
                            <label for="coin1" class="sc-label tether">
                                <span class="coin-txt"><?php echo e(__('Tether')); ?></span>
                            </label>
                        </div>
                        <div class="radio-el">
                        ...
                        <div class="radio-el">
                            ...
                            <label for="coin4" class="sc-label ed">
                                <span class="coin-txt"><?php echo e(__('Ethereum')); ?></span>
                            </label>
                        </div>
                    </div>

                    <div class="section what-do">
                        <h4 class="section-tit"><?php echo e(__('What would you like to do?')); ?></h4>
                            ...
                            <li>
                                <div class="radio">
                                    <input type="radio" id="sellTether" class="radio-inp" name="action" value="sell"
                                        checked>
                                    <label for="sellTether" class="radio-label"><?php echo e(__('Sell Tether')); ?></label>
                                </div>
                                <p class="info-txt small">
                                    <?php echo e(__('The transaction will be posted on the Tether purchase page.')); ?></p>
                            </li>
                            <li>
                                <div class="radio">
                                    <input type="radio" id="buyTether" class="radio-inp" name="action" value="buy">
                                    <label for="buyTether" class="radio-label"><?php echo e(__('Buy Tether')); ?></label>
                                </div>
                                <p class="info-txt small">
                                    <?php echo e(__('The transaction will be posted on the Tether selling page.')); ?></p>
                            </li>
                        </ul>
                    </div>

                    <div class="section how">
                        <h4 class="section-tit"><?php echo e(__('Select Payment Method')); ?></h4>
                            ...
                            <li>
                                <div class="checkbox aic">
                                    ...
                                    <label for="bankTrasfer" class="label-txt">
                                        <img src="<?php echo e(asset('/public/pub')); ?>/img/account-bank@2x.png" class="bank">
                                        <?php echo e(__('Bank Account Transfer')); ?>
                            ...
                            <li>
                                <div class="checkbox aic">
                                    ...
                                    <label for="kakaopay" class="label-txt">
                                        <img src="<?php echo e(asset('/public/pub')); ?>/img/qrCode.png" class="kakao">
                                        <?php echo e(__('Qr Pay')); ?>
                        ...
                        <p class="info-txt small">
                            <?php echo e(__('You can select both bank transfer and QR Pay at the same time.')); ?>

                        </p>
                    </div>

                    <div id="BankInfo" class="section b-transfer">
                        <h4 class="section-tit small"><?php echo e(__('계좌정보')); ?></h4>

                        <div class="bt-row">
                            <div class="custom-select" id="bankInfoSelect">
                                <button type="button" class="cs-btn bank-cs-btn">
                                    <span class="dp-txt bank-dp-txt"><?php echo e(__('최근거래 은행 선택')); ?></span>
                                </button>

                                <ul class="cs-list bank-cs-list">
                                    <?php $__empty_1 = true; $__currentLoopData = $bankinfoData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $bank): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <li><a href="#" class="value"
                                                onclick="onSelectMyAccount(<?php echo e($index); ?>); return false;"><?php echo e($bank->accountTag); ?></a>
                                        </li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <li><?php echo e(__('No bank accounts available')); ?></li>
                                    <?php endif; ?>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="bt-row">
                            <div class="input">
                                <input type="text" class="inp-txt" placeholder="<?php echo e(__('별칭')); ?>"
                                    value="<?php echo e($bankinfoData->isNotEmpty() ? $bankinfoData[0]->accountTag : ''); ?>"
                                    name="accountTag" id="accountTag">
                            </div>
                            <div class="input">
                                <input type="text" class="inp-txt" placeholder="<?php echo e(__('은행명')); ?>"
                                    value="<?php echo e($bankinfoData->isNotEmpty() ? $bankinfoData[0]->bankName : ''); ?>"
                                    name="bankName" id="bankName">
                            </div>

                            <div class="input long">
                                <input type="text" class="inp-txt" placeholder="<?php echo e(__('계좌 번호')); ?>"
                                    value="<?php echo e($bankinfoData->isNotEmpty() ? $bankinfoData[0]->accountNumber : ''); ?>"
                                    name="accountNumber" id="accountNumber">
                            </div>

                            <div class="input">
                                <input type="text" class="inp-txt" placeholder="<?php echo e(__('예금주')); ?>"
                                    value="<?php echo e($bankinfoData->isNotEmpty() ? $bankinfoData[0]->accountHolder : ''); ?>"
                    ...
                    <div id="KakaopayInfo" class="section kakao-qr">
                        <h4 class="section-tit small"><?php echo e(__('QR 페이 이미지')); ?></h4>

                        <div class="qr-row">
                            <div class="add-file-row">
                                <input type="text" style="color: black;"
                                    value="<?php echo e($payqrData->isNotEmpty() ? $payqrData[0]->payQR : ''); ?>" name="payQRUrl"
                                    id="payQRUrl" hidden />
                                <div class="input">
                                    <input type="hidden" class="inp-txt" placeholder="<?php echo e(__('별칭')); ?>"
                                        value="<?php echo e($payqrData->isNotEmpty() ? $payqrData[0]->payTag : __('카카오뱅크')); ?>"
                                        name="payTag" id="payTag" style="width: 160px; margin-right: 10px;" />
                                </div>
                                <div class="input">
                                    <button type="button" class="btn-add-file" onclick="addFile();"><?php echo e(__('+ 파일 선택')); ?></button>
                                </div>
                                <div class="input">
                                    <input type="file" class="inp-hide" onchange="handleFileChange(event);"
                                        name="payQRImage" id="payQRImage">
                                    <span class="guide-t"><?php echo e(__('QR 페이 이미지 선택하세요')); ?></span>
                                </div>
                            </div>
                    ...
                    <div class="pc-btn">
                        <button type="button" class="process-btn" id="nextBtn" onclick="onNextClick()">
                            <span class="txt"><?php echo e(__('Next')); ?></span>
                        </button>
                    </div>
                </div>
            </div>
        ...
        <div id="Phase2" class="content offer offer2">
            ...
            <div class="container-row">
                <div class="card-box border">
                    ...
                    <h3 class="step-tit"><?php echo e(__('Select the Tether price to use.')); ?></h3>
                    ...
                    <div>
                        <div class="select-price">
                            <button type="button" class="sp-col btn-radio active">
                                ...
                                <p class="sptxt">
                                    <?php echo e(__('The sale price of the transaction will change based on the fluctuation of the Tether market price')); ?>
                            ...
                            <button type="button" class="sp-col btn-radio">
                                ...
                                <p class="sptxt">
                                    <?php echo e(__('The sale price of the transaction will remain fixed regardless of market fluctuations')); ?>
                        ...
                        <div class="dt-row">
                            <div class="dt-col">
                                <label for="price" class="dt-label"><?php echo e(__('Set Transaction Amount')); ?></label>
                                <label class="dt-label"
                                    style="margin-left: 10px; color: rgb(83,126,238)"><?php echo e(__('Min. 15,000원 ~ Max. 제한없음')); ?></label>
                                <div class="dt-inp">
                                    <input type="text" id="price" class="input"
                                        placeholder="<?php echo e(__('Minimum Amount')); ?>" value="100,000" name="tradeVolMin"
                                        id="tradeVolMin">
                            ...
                            <div class="dt-col">
                                <div class="dt-inp">
                                    <input type="text" id="receipt" class="input"
                                        placeholder="<?php echo e(__('Maximum Amount')); ?>" value="1,000,000" name="tradeVolMax"
                                        id="tradeVolMax">
                                    <span class="unit"><?php echo e(__('KRW')); ?></span>
                                </div>
                            </div>
                        ...
                        <div class="section" id="FixedPriceGroup">
                            ...
                            <div class="setting-inp money">
                                <input type="number" class="si-inp inp-m" value="<?php echo e($prices['KRW']); ?>"
                        ...
                        <div class="section">
                            ...
                            <p class="setting-txt">
                                <?php echo e(__('If the transaction is not completed within the set time, it will be automatically cancelled. (Minimum 20 minutes required)')); ?>
        ...
        <div id="Phase3" class="content offer offer3">
            <h2 class="page-tit"><?php echo e(__('Make Offer')); ?></h2>
                        ...
                        <div class="section">
                            <div class="checkbox aic">
                                ...
                                <label for="secretTrade"
                                    class="checkbox__label section-tit"><?php echo e(__('Private Trade Password lock feature')); ?></label>
                            ...
                            <div class="input" name="passwordGroup" id="passwordGroup">
                                <div class="i-txt password w-full">
                                    <div class="i-txt__wrap">
                                        <input type="password" class="i-txt__input" placeholder="<?php echo e(__('Enter 4-digit password')); ?>"
                            ...
                            <div class="section">
                                <h4 class="section-tit"><?php echo e(__('Trade Restriction')); ?></h4>
                                <div class="checkbox aic">
...
<?php echo e(__('1. 카카오뱅크로만 거래합니다.')); ?>

<?php echo e(__('2. 채팅으로 본인 확인을 합니다.')); ?>

<?php echo e(__('3. 본인 명의가 아니면 거래가 힘듭니다.')); ?>

<?php echo e(__('4. 불법적인 거래(마약, 도박 등)는 안 합니다.')); ?>
                        ...
                        <div class="pc-btn">
                            <button type="submit" class="process-btn" id='make-trade'>
                                <span class="txt"><?php echo e(__('Confirm Trade Creation')); ?></span>
                            </button>
                        </div>
                    </div>
                </div>
    ...
    <div class="pop-sheet" data-pop-sheet="sheet1">
        <div class="ps-inner">
            <div class="ps-container">
                <div class="ps-head">
                    <h2 class="ps-tit"><?php echo e(__('Confirm Trade Creation')); ?></h2>
                </div>

                <div class="ps-content custom-scroll trans">
                    <div class="offer4">
                        <div class="offer-code">
                            <p class="oc-txt"><?php echo e(__('아래의 링크를 복사하고 직접 공유하셔도 됩니다.')); ?></p>

                            <div class="oc-code-sub">
                                <p class="oc-code-txt">
                                </p>
                                <button type="button" class="oc-copy"><img
                                        src="<?php echo e(asset('/public/pub')); ?>/img/copy@2x.png" alt="<?php echo e(__('클립보드에 복사')); ?>"></button>
                            </div>
                        </div>
                        <div class="of4-sumarry">
                            <ul class="of4-sumarry-list">
                                <li class="of4-sumarry-row">
                                    <span class="of4-sumarry-label"><?php echo e(__('가격')); ?></span>
                                ...
                                <li class="of4-sumarry-row">
                                    <span class="of4-sumarry-label"><?php echo e(__('거래량 제한')); ?></span>
                                    <span class="of4-sumarry-data"></span>
                                </li>
                                <li class="of4-sumarry-row">
                                    <span class="of4-sumarry-label"><?php echo e(__('거래 시간 제한')); ?></span>
                                    <span class="of4-sumarry-data"></span>
                                </li>
                                <li class="of4-sumarry-row" id="anaki_fee">
                                    <span class="of4-sumarry-label"><?php echo e(__('ANAKI 수수료')); ?>

                                        <div class="tooltip">
                                            <button type="button" class="tt-a"><span class="tt-q blind"><?php echo e(__('수수료')); ?></span></button>
                                            <div class="tt-cont">
                                                <!-- 등급 제거  -->
                                                <!-- <ul class="tt-list">
                                                    <li class="tt-list-item jcsb">
                                                        <span class="tt-list-txt"><?php echo e(__('일반')); ?></span>
                                                        <span class="tt-list-txt">0.8%</span>
                                                    </li> -->
                                                    <!-- <li class="tt-list-item jcsb">
                                                        <span class="tt-list-txt"><?php echo e(__('실버')); ?></span>
                                                        <span class="tt-list-txt">0.6%</span>
                                                    </li>
                                                    <li class="tt-list-item jcsb">
                                                        <span class="tt-list-txt"><?php echo e(__('골드')); ?></span>
                                                        <span class="tt-list-txt">0.5%</span>
                                                    </li>
                                                    <li class="tt-list-item jcsb">
                                                        <span class="tt-list-txt"><?php echo e(__('다이아')); ?></span>
                        ...
                        <div class="of4-dl">
                            ...
                            <dl>
                                <dt><?php echo e(__('인증')); ?></dt>
                                <dd class="dot"><?php echo e(__('전화번호 실명 인증을 완료한 파트너만 거래 가능')); ?></dd>
                                <dd class="dot"><?php echo e(__('KYC 인증을 완료한 파트너만 거래 가능')); ?></dd>
                            </dl>
                        </div>
                    </div>
                </div>
                ...
                <div class="ps-process">
                    <button type="button" class="ps-process-btn" id="confirmFinalBtn">
                        <span class="txt"><?php echo e(__('Confirm')); ?></span>
                    </button>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function refreshPhase() {
            if (phase == 2) {
                ...
                if (action === 'buy') {
                    phase2Title.textContent = "<?php echo e(__('Create Trade Buyer')); ?>";
                } else {
                    phase2Title.textContent = "<?php echo e(__('Create Trade Seller')); ?>";
                }
        ...
        function onNextClick() {
            ...
            if (!bankTransfer && !kakaopay) {
                alert('<?php echo e(__("Please register a payment method")); ?>');
                return
            }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            window.onpopstate = function() {
                window.location.href='<?php echo e(setRoute('user.make-offer.index')); ?>';
            };
            ...
            form.addEventListener('submit', function(e) {
                ...
                // fetch('<?php echo e(setRoute('user.make-offer.submit')); ?>', {
                //         method: 'POST',
                //         body: formData,
                //         headers: {
                ...
                //         showNotification("<?php echo e(__('예기치 않은 오류가 발생했습니다. 다시 시도해 주세요.')); ?>", "error");
                //     });
                fetch('<?php echo e(setRoute('user.make-offer.submit')); ?>', {
                        method: 'POST',
                        body: formData,
            ...
            function populatePopSheet(data) {
                ...
                const shareUrl = `<?php echo e(config('app.url')); ?>/user/${data.action}-list/preview/${data.order_id}`;
                ...
                copyButton.addEventListener('click', () => {
                    navigator.clipboard.writeText(shareUrl)
                        .then(() => {
                            ...
                            alert('<?php echo e(__('URL이 클립보드에 복사되었습니다.')); ?>');
                        })
                        .catch(err => {
                            console.error('클립보드 복사 실패:', err);
                            alert('<?php echo e(__('URL 복사에 실패했습니다. 수동으로 복사해 주세요.')); ?>');
                        });
                });
                ...
                if (data.item.priceType === 0) {
                    priceElement.innerHTML =
                        `${data.prices.KRW.toLocaleString()} <?php echo e(__('KRW')); ?> <i class="${data.item.offerMargin >= 0 ? 'up' : 'down'}"> ${data.item.offerMargin}%</i>`;
                } else {
                ...
                timeLimitElement.textContent = `${data.item.offerTimeLimit}<?php echo e(__('Minute')); ?>`;
...
<?php echo $__env->make('user.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/user/make-offer/index.blade.php ENDPATH**/ ?>