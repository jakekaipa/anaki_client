        ...
        window.addEventListener('message', (e) => {
            ...
            try {
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        showModal('errorModal', "<?php echo e(__('Something went wrong. Please try again.')); ?>");
                    }
                });
...
<?php /**PATH /var/www/html/resources/views/user/sections/kyc/kyc-iframe.blade.php ENDPATH**/ ?>