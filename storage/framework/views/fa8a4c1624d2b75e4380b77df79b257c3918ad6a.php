...
<head>
    ...
    <script src="<?php echo e(asset('pub/js/jquery-3.5.1.min.js')); ?>"></script>
...
<body class="<?php echo e(Session::get('side-menu', '')); ?>">
    <div class="wrap">
    ...
    <?php echo $__env->make('user.partials.notify', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

    <?php echo $__env->make('user.layouts.chat', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            window.pusherInstance.bindEvent('new.message', (data) => {
                ...
                if (!$('.chat-layer').is(':visible')) {
                    <?php
                        $text = __('메세지 수신');     
                    ?>
                    let text = <?php echo json_encode($text, 15, 512) ?>;
...
<?php /**PATH /var/www/html/resources/views/user/layouts/master.blade.php ENDPATH**/ ?>