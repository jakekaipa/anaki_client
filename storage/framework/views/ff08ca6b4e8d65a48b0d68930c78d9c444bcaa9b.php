...
<?php $__env->startSection("content"); ?>
    <div class="four-not-four-section">
        <div class="four-not-four-wrapper">
            ...
            <img src="<?php echo e(asset("public/error-images/500-(Server-Error).png")); ?>" alt="500" class="error-bg">
                <div class="four-not-four-element-one">
                    <img src="<?php echo e(asset("public/error-images/5.png")); ?>" alt="five">
                </div>
                <div class="four-not-four-element-two">
                    <img src="<?php echo e(asset("public/error-images/0.png")); ?>" alt="zero">
                </div>
            ...
            <div class="four-not-four-content">
                <h1 class="title"><?php echo e(__("Server Error...!")); ?></h1>
                <div class="four-not-four-btn">
                    <a href="<?php echo e(setRoute("index")); ?>" class="btn--base"><?php echo e(__("Back To Home")); ?></a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('errors.custom-layouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/errors/500.blade.php ENDPATH**/ ?>