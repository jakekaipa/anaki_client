        ...
        <div class="container-fluid px-4">
            ...
            <div class="card mb-4">
                <div class="card-header">
                    ...
                    전체 지갑 간 전송 건수 :  <?php echo e($walletTransferCount); ?>
                ...
                <div class="card-body">
                    <form id="submitForm" action="" method="GET">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <?php 
                                    $count = ($page-1)*10+1; 
                                ?>
                                <?php $__currentLoopData = $walletTransferList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                                    <tr style="text-align: center;">
                                        <td style="width:5%"><?php echo e($count); ?></td>
                                        <td style="width:12%"><?php echo e($list->senderUsername); ?>( <?php echo e($list->senderRealName); ?> )</td>
                                        <td style="width:11%"><?php echo e($list->receiverUsername); ?> ( <?php echo e($list->receiverRealName); ?> )</td>
                                        <td style="width:11%">
                                        <?php if(floor($list->amount) == $list->amount): ?>
                                            <?php echo e(number_format($list->amount, 0)); ?> 
                                        <?php else: ?>
                                            <?php echo e(number_format($list->amount, 5)); ?>  
                                        <?php endif; ?>
                                        </td>
                        ...
                        <div class="pagination">
                            <?php echo e($walletTransferList->links()); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.mainLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/transferWalletList.blade.php ENDPATH**/ ?>