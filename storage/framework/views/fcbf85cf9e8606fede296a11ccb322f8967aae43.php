...
<?php $__env->startSection('style'); ?>
    <style>
        ...
        canvas {
            ...
            min-height: 700px !important;  /* 최소 높이 700px */
        }
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        var userCountData = <?php echo json_encode($userCountData, 15, 512) ?>;

        // 동적 날짜 라벨 생성
        var labels = userCountData.map(function(item) {
            return item.date;
        });

        // USDT 값 추출
        var userCountDataValues = userCountData.map(function(item) {
            return item.value;
        });
...
<?php echo $__env->make('admin.layouts.mainLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/dataStatsRegistUser.blade.php ENDPATH**/ ?>