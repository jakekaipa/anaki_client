            ...
            <div class="card-box">
                <div class="table-wrap">
                    <table class="tbl-list dsbo-tbl">
                        ...
                        <thead>
                            <tr>
                                <th><?php echo e(__('거래 구분')); ?></th>
                                <th><?php echo e(__('거래자 이름')); ?></th>
                                <th><?php echo e(__('Tether Purchase Amount')); ?></th>
                                <th><?php echo e(__('Purchase Price')); ?></th>
                                <th><?php echo e(__('Offered Price')); ?></th>
                                <th><?php echo e(__('Status')); ?></th>
                                <th><?php echo e(__('Trade start time')); ?></th>
                                <th><?php echo e(__('Trade end time')); ?></th>
                                <th></th>
                            </tr>
                        </thead>

                        <tbody id="trade-list-container">
                            <?php echo $__env->make('user.my-trade.partials.list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </tbody>
                    </table>
                </div>
            </div>
    ...
    <div class="pop-sheet" data-pop-sheet="sell_detail">
        <div class="ps-inner">
            <div class="ps-container">
                <div class="ps-head">
                    <h2 class="ps-tit"><?php echo e(__('거래 상세 정보')); ?></h2>
                </div>
                    ...
                    <div class="dt-pop">
                        ...
                        <div class="dt-buy">
                            <div class="buy-row">
                                ...
                                <div class="pay-proof-img"><img src="" alt="<?php echo e(__('입금 증빙 이미지')); ?>"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="ps-process">
                    <button class="ps-process-btn white w-200" onclick="onDownloadPDFButton()">
                        <span class="txt pdf"><?php echo e(__('PDF 출력')); ?></span>
                    </button>
                </div>
...
<?php $__env->startPush('script'); ?>
    <script>
        ...
        function loadMoreItems() {
            currentPage++;
            fetch(`<?php echo e(route('user.mytrade.index')); ?>?page=${currentPage}`, {
                    headers: {
        ...
        function showTradeDetails(_order_id, encryptOrderId) {
            ...
            fetch(`<?php echo e(route('user.mytrade.details', '')); ?>/${encryptOrderId}`)
                ...
                .catch(error => {
                    ...
                    alert('<?php echo e(__('Error fetching trade details. Please try again.')); ?>');
                });
        }
        ...
        function updateSellDetailPopup(data) {
            ...
            switch(data.state) {
                case "cancel":
                    statusMsg = "<?php echo e(__('Cancel')); ?>"
                    break;
                case "done":
                    statusMsg = "<?php echo e(__('Complete')); ?>"
                    break;
            }
            ...
            /*
                ${Number(data.price).toLocaleString()} <?php echo e(__('KRW')); ?>

                ${priceGap}
            */

            document.querySelector('[data-pop-sheet="sell_detail"] .market-price').textContent =
                `<?php echo e(__('시장가')); ?>: ${Number(parseFloat(data.market_price).toFixed(2)).toLocaleString()} <?php echo e(__('KRW')); ?>`;
            ...
            document.querySelector('[data-pop-sheet="sell_detail"] li:nth-child(5) .data-txt').textContent =
                `${Number(parseFloat(data.total_amount).toFixed(2)).toLocaleString()} <?php echo e(__('KRW')); ?>`;
        ...
        function onDownloadPDFButton() {
            window.location.href = `<?php echo e(route('user.mytrade.downloadpdf', '')); ?>/${itemId}`;
        }
...
<?php echo $__env->make('user.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/user/my-trade/index.blade.php ENDPATH**/ ?>