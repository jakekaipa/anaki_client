...
<?php $__env->startSection('content'); ?>
    <div class="content kyc">
        <h2 class="page-tit"><?php echo e(__('KYC Verification')); ?></h2>

        <div class="container-row">
            <div class="sub-box">
                <strong class="cb-tit"><?php echo e(__('본인 확인 증명')); ?></strong>

                <div class="kyc-guide" id="kyc_form">
                    <?php if(auth()->user()->kyc_verified == global_const()::APPROVED): ?>
                        <div class="approved text--success kyc-text"><?php echo e(__('Your KYC information is verified')); ?>

                        </div>
                    <?php else: ?>
                        <p class="kyc-txt1"><?php echo e(__('유효한 KYC 정보를 제출하십시오')); ?></p>
                        <div class="kyc-img"><img src="<?php echo e(asset('/public/pub')); ?>/img/kyc-certification@2x.png"></div>
                        <p class="kyc-txt2"><?php echo e(__('주민등록증 또는 운전면허증 필요합니다')); ?><br><?php echo e(__('준비되었으면 시작을 클릭해 주세요')); ?></p>
                        <div class="kyc-btn">
                            <button class="btn-default" onclick="openInput()">  <!--openInput()  onBegin() -->
                                <span class="txt"><?php echo e(__('Start')); ?></span>
                            </button>
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <div id="inputList">
                    <table>
                        ...
                        <tr>
                            <td>
                                <label for="birthday"><?php echo e(__('birthday')); ?></label>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td colspan="2">
                                <input type="button" value="<?php echo e(__('submit')); ?>" onclick="onBegin()">
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <div id="kycContainer" class="row mb-30-none justify-content-center" style="height:100%">
                    ...
                    <div id="kyc_resultPanel" style="display: none;">
                        ...
                        <form action="<?php echo e(setRoute('user.authorize.kyc.submit')); ?>" method="POST"
                            enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>

                            <div class="">
                                <button type="submit" id="submitButton" style="display: none"
                                    class="btn-default"><?php echo e(__('submit')); ?></button>
                            </div>
                        </form>
                    </div>
                </div>
...
<!-- 
        <form id="kycInfoUpdate" method="POST" action="<?php echo e(setRoute('user.profile.kycinfo.update')); ?>">
            <?php echo csrf_field(); ?>
        ...
        <script>
            ...
            window.addEventListener('message', (e) => {
                ...
                try {
                    ...
                    // 받은 데이터 전달 
                    $.ajax({
                        url: "<?php echo e(setRoute('user.profile.kycinfo.update')); ?>",
                        method: 'POST', 
                        data: {
                            ...formData,
...
<?php echo $__env->make('user.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/user/sections/kyc/verify-kyc.blade.php ENDPATH**/ ?>