...
<head>
    ...
    <title><?php echo e(__('QrCode Scan')); ?></title>
    <style>
        /* 기본 스타일 */
        body {
            margin: 0;
...
<body>
    <h2><?php echo e(__('QrCode Scan')); ?></h2>
    <video id="qr-video"></video>
    <!-- <button class="button" onclick="closeScanner()"><?php echo e(__('Close')); ?></button> -->
    ...
    <script type="module">
        ...
        window.onload = function() {
            ...
            qrScanner.start().catch(err => {
                ...
                resultElem.textContent = "<?php echo e(__('An error occurred. Please try again.')); ?>";
                errorElem.textContent = "<?php echo e(__('Permission not found.')); ?>";
            });
        };
...
</html><?php /**PATH /var/www/html/resources/views/user/wallet/qrcode-reader.blade.php ENDPATH**/ ?>