...
class AdminCareController extends Controller
{
    ...
    public function index()
    {
        ...
        $qr_code = generate_google_2fa_auth_qr_admin();
    ...
    public function sendEmail(Request $request) {
        ...
        try{
            ...
            return back()->with(['error' => ['Failed to send mail. Please check your mail credentials or reconfigure mail.']]);
        }
    ...
    public function update(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'edit_password'     => "required|string|max:20",
