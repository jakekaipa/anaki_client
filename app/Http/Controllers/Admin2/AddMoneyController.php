...
class AddMoneyController extends Controller
{
    ...
    public function index()
    {
        ...
        )->where('type', 'add-money')->orderBy('id', 'desc')->paginate(20);
    ...
    public function pending()
    {
        ...
        $transactions = Transaction::with(
            'user:id,firstname,email,username,mobile',
        )->where('type', 'add-money')->where('status', 2)->orderBy('id', 'desc')->paginate(20);
        return view('admin.sections.add-money.index', compact(
            'page_title',
            'transactions'
        ));
    ...
    public function complete()
    {
        ...
        $transactions = Transaction::with(
            'user:id,firstname,email,username,mobile',
        )->where('type', 'add-money')->where('status', 1)->orderBy('id', 'desc')->paginate(20);
        return view('admin.sections.add-money.index', compact(
            'page_title',
            'transactions'
        ));
    ...
    public function canceled()
    {
        ...
        $transactions = Transaction::with(
            'user:id,firstname,email,username,mobile',
        )->where('type', 'add-money')->where('status', 4)->orderBy('id', 'desc')->paginate(20);
        return view('admin.sections.add-money.index', compact(
            'page_title',
            'transactions'
        ));
    ...
    public function approved(Request $request){
        ...
        try{
            ...
            $userWallet = UserWallet::where('user_id',$data->user_id)->where('currency_id', $currency->id)->first();
