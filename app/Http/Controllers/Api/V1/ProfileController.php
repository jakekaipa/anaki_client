...
class ProfileController extends Controller
{
    ...
    public function profile()
    {
        ...
        $message =  ['success' => ['Trader Profile']];
    ...
    public function google2FA()
    {
        ...
        $data = [
            ...
            'qr_status'  => $qr_status,
            'alert' => __("Add a QR code or address to the Google Authenticator app. When 'activated', a security code will be used for logging in and transferring coins from your wallet."),
        ];
