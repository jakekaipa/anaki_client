...
class DashboardController extends Controller
{
    ...
    */
    ...
    public function dashboard(Request $request){
        ...
        $user_data =[
            ...
            'user'          => isset($user) ? new UserResouce($user) : null,
        ];
    ...
    */
    ...
    public function campaigns(Request $request){
        ...
        $message =  ['success'=>['Campaigns successfully fetch!']];
        return ApiResponse::success($message, $data);
    }
    ...
    */
    ...
    public function campaignDetails(Request $request){
        ...
        $message =  ['success'=>['Campaign Details successfully fetch1!']];
        return ApiResponse::success($message, $data);
    }
    ...
    */
    ...
    public function events(Request $request){
        ...
        $message =  ['success'=>['Events successfully fetch!']];
        return ApiResponse::success($message, $data);
    }
    ...
    */
    ...
    public function eventDetails(Request $request){
        ...
        $message =  ['success'=>['Event Details successfully fetch!']];
        return ApiResponse::success($message, $data);
    }
