...
class PushNotificationController extends Controller
{
    ...
    public function send(Request $request) {
        ...
        if(!$basic_settings->push_notification_config) {
            return back()->with(['error' => ['You need to configure push notifications before sending them.']]);
        }
    ...
    public function sendNotificationWithPusher($data) {
        ...
        try{
            ...
            return back()->with(['error' => ['Failed to store information.']]);
        }
    ...
    public function update(Request $request)
    {
        ...
        if(!$basic_settings) {
            return back()->with(['error' => ['Basic setting not found.']]);
        }
