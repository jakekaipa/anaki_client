...
class UserController extends Controller
{
    ...
    public function showLoginForm(Request $request)
    {
        ...
        if ($request->isMethod("POST")) {
            ...
            if (isset($userCheck) && $userCheck->status == 0) {
                return redirect()->back()->with(['error' =>  ['Your account is not activated. Check your mail inbox/spam.']]);
            }
    ...
    public function confirmAccount($email)
    {
        ...
        if ($vendorCount > 0) {
            ...
            if ($userDetails->status == 1) {
                return redirect()->route('user.login')->with(['error' => 'Your email account is already activated. Please log in.']);
            } else {
                ...
                return redirect()->route('user.login')->with(['success' => ['Your email account is activated. You can now login and update your necessary information to upload products.']]);
            }
        } else {
            abort(404);
        }
    ...
    public function forgotPasswordCodeGenerate(Request $request)
    {
        if ($request->isMethod("POST")) {
            ...
            if (isset($userCheck)) {
                ...
                return redirect('user/enter/pwd/reset/code')->with(['success' => ['Please check your email inbox/spam.']]);
            } else {
    ...
    public function setNewPassword(Request $request, $username)
    {
        ...
        if ($request->isMethod('POST')) {
            ...
            return redirect('/user/login')->with(['success' =>  ['Password changed successfully. Please login.']]);
        } else {
