...
class ForgotPasswordController extends Controller
{
    ...
    public function sendCode(Request $request)
    {
        ...
        return redirect()->route('user.password.forgot.code.verify.form', $token)->with(['success' => ['Password reset code sent to your email.']]);
    }
    ...
    public function resendCode($token)
    {
        ...
        return redirect()->route('user.password.forgot.code.verify.form', $token)->with(['success' => ['Password reset code resent successfully.']]);
    }
    ...
    public function resetPassword(Request $request, $token)
    {
        ...
        return redirect()->route('user.login')->with(['success' => ['Password reset successful. Please login with new password.']]);
    }
}
