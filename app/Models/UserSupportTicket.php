...
class UserSupportTicket extends Model
{
    ...
    public function getComments(){
        return $this->hasmany(UserSupportTicketComments::class);
    }

    public function getCommentsOne(){
        return $this->hasone(UserSupportTicketComments::class);
    }
