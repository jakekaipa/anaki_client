...
trait CoinGate {
    ...
    public function coinGateInit($output = null) {
        ...
        $request_credentials = $this->getRequestCredentials();
    ...
    public function getValueFromGatewayCredentials($gateway, $keywords) {
        ...
        foreach($keywords as $item) {
            ...
            $modify_item = $this->makeCoinPlainText($item);
            foreach($gateway->credentials ?? [] as $gatewayInput) {
                $label = $gatewayInput->label ?? "";
                $label = $this->makeCoinPlainText($label);
    ...
    public function makeCoinPlainText($string) {
        $string = Str::lower($string);
        return preg_replace("/[^A-Za-z0-9]/","",$string);
    }

    public function getRequestCredentials($output = null) {
